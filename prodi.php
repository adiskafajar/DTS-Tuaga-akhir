...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h4 class='text-uppercase'><?= $content ?> Data Prodi</h4>
			</div>
			<div class="col-md-10">
			<?php
				...
				switch ($content) {
					case 'add':
						require 'operasi_prodi/create.php';
						break;
					case 'delete':
						require 'operasi_prodi/delete.php';
						break;
					case 'update':
						require 'operasi_prodi/update.php';
						break;
					default:
						require 'operasi_prodi/read.php';
						break;
				} 
			?>
			</div>
