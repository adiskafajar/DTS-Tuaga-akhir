	...
	<table class="table table-sm">
		...
		<tbody>
			...
			<tr>
				...
				<td><?= $data['email'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index.php?page=update&nim=<?= $data['nim'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['nim'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index.php?page=delete&nim='+idn);
