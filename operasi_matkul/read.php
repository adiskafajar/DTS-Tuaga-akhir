...
<a href="<?= $WEB_CONFIG['base_url'] ?>matkul.php?page=add" class="btn btn-primary mb-3">
	...
	<table class="table table-sm">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>matkul.php?page=update&id=<?= $data['id'] ?>" class="btn btn-success m-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>matkul.php?page=delete&id='+idn);
