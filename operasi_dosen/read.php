...
<a href="<?= $WEB_CONFIG['base_url'] ?>dosen.php?page=add" class="btn btn-primary mb-3">
	...
	<table class="table table-sm">
		...
		<tbody>
			...
			<tr>
				...
				<td><?= $data['email'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>dosen.php?page=update&nip=<?= $data['nip'] ?>" class="btn btn-success m-1">
                  <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
					...
					<a href="javascript:alertDelete(<?= $data['nip'] ?>);" class="btn btn-danger m1">
                  <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>dosen.php?page=delete&nip='+idn);
