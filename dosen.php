...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h4 class='text-uppercase'><?= $content ?> Data Dosen</h4>
			</div>
			<div class="col-md-10">
			<?php
				...
				switch ($content) {
					case 'add':
						require 'operasi_dosen/create.php';
						break;
					case 'delete':
						require 'operasi_dosen/delete.php';
						break;
					case 'update':
						require 'operasi_dosen/update.php';
						break;
					default:
						require 'operasi_dosen/read.php';
						break;
				} 
			?>
			</div>
